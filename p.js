...
function showMeme() {
  ...
  const isimg=memeContent.querySelector('img');
  if(isimg){
...
function showJoke() {
  ...
  jokeContent.textContent=randomJokeText;
  const isjoke=joke.querySelector('p');
  if(isjoke){
   joke.innerHTML=''; 
  }
...
function showQuote() {
  ...
  const isQuote=quote.querySelector('p');
  if(isQuote){
    quote.innerHTML='';
  }
...
const answer=document.createElement('p');
 answer.textContent=randomRiddle.answer; newRiddle.textContent=randomRiddle.question;
...
function revealAnswers() {
  const riddle=document.querySelector('.riddle');
  const riddleContent=riddle.querySelector('p');
